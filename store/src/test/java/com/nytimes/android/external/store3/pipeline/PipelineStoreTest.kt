...
class PipelineStoreTest {
    ...
    fun streamAndFresh_withPersister() = testScope.runBlockingTest {
        ...
        assertThat(
            ...
            listOf(
                StoreResponse.LoadingResponse<String>(data = null),
                StoreResponse.SuccessResponse<String>(data = "three-1")
            )
        )
        assertThat(
            pipeline.streamCollect(3)
            ...
            listOf(
                StoreResponse.LoadingResponse<String>(data = "three-1"),
                StoreResponse.SuccessResponse<String>(data = "three-2")
            )
        )
    }
